...
#### fetch index registry - attested with sigstore - immutable releases
> [Github Workflow](.github/workflows/main.yml)

#### client side validation of index against expiry, attested pki, then liveness
> [local.sh](local.sh) #WIP

#### add checks at the project level script & attestation checks # WIP
```
